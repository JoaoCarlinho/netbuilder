  	     ...
  	     try {
  			...
  			//read current porous quantity
				...
				if (receivedAmount <= porousDeficit){
					...
					porousAllocation = porousDeficit;
					}
     ...
     try {
  	...
  	public void addInventory(Product theProduct) throws Exception{
  	  ...
  	  //int newPorous = keyboard.nextInt();
  				...
  				stmt.setInt(3, theProduct.getShelvedQuantity());
  				stmt.setInt(4, theProduct.getReservedQuantity());
  				stmt.setInt(5, theProduct.getPorousAvailable());
  				stmt.setInt(6, theProduct.getMinPorous());
  				stmt.setInt(7, theProduct.getNonPorousAvailable());
  				stmt.setInt(8, theProduct.getPorousReserved());
  				stmt.setInt(9, theProduct.getNonPorousReserved());
